...
public class ChangedAddonTrades {
    ...
    public static void registerTrades(VillagerTradesEvent event) {
        ...
        list.add(new BasicItemListing(new ItemStack(Items.EMERALD, 8), new ItemStack(ChangedAddonItems.IMPURE_AMMONIA.get(), 1), new ItemStack(ChangedAddonItems.AMMONIA_PARTICLE.get(), 6), 8, 10, 0.02f));

        // Level 2 Trades
        list = trades.get(2);
        list.add(new BasicItemListing(new ItemStack(ChangedItems.DARK_LATEX_MASK.get()), new ItemStack(Items.EMERALD, 3), 12, 10, 0.02f));
        list.add(new BasicItemListing(new ItemStack(ChangedItems.WHITE_LATEX_GOO.get(), 16), new ItemStack(Items.EMERALD), 12, 10, 0.02f));
        list.add(new BasicItemListing(new ItemStack(ChangedItems.DARK_LATEX_GOO.get(), 16), new ItemStack(Items.EMERALD), 12, 10, 0.02f));
        list.add(new BasicItemListing(new ItemStack(Items.EMERALD, 1), new ItemStack(ChangedItems.WHITE_LATEX_GOO.get(), 2), 12, 15, 0.02f));
        list.add(new BasicItemListing(new ItemStack(Items.EMERALD, 1), new ItemStack(ChangedItems.DARK_LATEX_GOO.get(), 2), 12, 15, 0.02f));
        list.add(new BasicItemListing(new ItemStack(Items.EMERALD, 10), new ItemStack(ChangedAddonItems.AMMONIA_COMPRESSED.get(), 2), 8, 10, 0.02f));
        list.add(new BasicItemListing(new ItemStack(Items.EMERALD, 12), new ItemStack(ChangedAddonItems.AMMONIA.get(), 2), 8, 15, 0.02f));

        // Level 3 Trades
        list = trades.get(3);
        list.add(new BasicItemListing(new ItemStack(ChangedAddonItems.LATEX_INSULATOR.get(), 4), new ItemStack(Items.EMERALD, 1), 12, 10, 0.02f));
        list.add(new BasicItemListing(new ItemStack(ChangedBlocks.DARK_LATEX_BLOCK.get().asItem(), 4), new ItemStack(Items.EMERALD, 1), 12, 15, 0.02f));
        list.add(new BasicItemListing(new ItemStack(ChangedBlocks.WHITE_LATEX_BLOCK.get().asItem(), 4), new ItemStack(Items.EMERALD, 1), 12, 15, 0.02f));
        list.add(new BasicItemListing(new ItemStack(Items.EMERALD, 4), new ItemStack(ChangedAddonItems.LITIX_CAMONIA.get(), 2), 12, 15, 0.02f));
        list.add(new BasicItemListing(new ItemStack(Items.EMERALD, 1), new ItemStack(ChangedAddonItems.SIGNAL_CATCHER.get()), 12, 15, 0.02f));
        list.add(new BasicItemListing(new ItemStack(Items.EMERALD, 4), new ItemStack(ChangedAddonItems.SNEPSI.get(), 1), 12, 15, 0.02f));
        list.add(new BasicItemListing(new ItemStack(Items.EMERALD, 2), new ItemStack(ChangedAddonItems.FOXTA.get(), 1), 12, 15, 0.02f));
