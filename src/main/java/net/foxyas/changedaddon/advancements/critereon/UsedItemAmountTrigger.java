...
public class UsedItemAmountTrigger
    ...
    public static final ResourceLocation ID =
            new ResourceLocation("changed_addon", "used_item_amount");


    @Override
    protected @NotNull Instance createInstance(@NotNull JsonObject json, EntityPredicate.@NotNull Composite player, @NotNull DeserializationContext pContext) {
        ...
        return new Instance(player, item, min, max);
    }
