...
public class ChangedAddonVillagerProfessions {
    ...
    public static final RegistryObject<VillagerProfession> SCIENTIST = registerProfession("scientist", ChangedAddonBlocks.UNIFUSER::get, () -> SoundEvents.BREWING_STAND_BREW);
