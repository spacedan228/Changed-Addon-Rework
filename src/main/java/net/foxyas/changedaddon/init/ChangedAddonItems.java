...
public class ChangedAddonItems {
    ...
    public static final RegistryObject<Item> PROTOGEN_0SENIA0_SPAWN_EGG = REGISTRY.register("protogen_0senia0_spawn_egg", () -> new ForgeSpawnEggItem(ChangedAddonEntities.PROTOGEN_0SENIA0, Color3.getColor("#4d0ddb").toInt(), Color3.getColor("#4d0ddb").toInt(), new Item.Properties()));
