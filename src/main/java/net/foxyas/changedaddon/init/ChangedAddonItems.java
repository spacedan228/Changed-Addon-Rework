...
public class ChangedAddonItems {
    ...
    public static final RegistryObject<BlockItem> SNEP_PLUSH = block(ChangedAddonBlocks.SNEP_PLUSH, ChangedAddonTabs.CHANGED_ADDON_MAIN_TAB);
    public static final RegistryObject<BlockItem> WOLF_PLUSH = block(ChangedAddonBlocks.WOLF_PLUSH, ChangedAddonTabs.CHANGED_ADDON_MAIN_TAB);
    ...
    public static final RegistryObject<Item> BUNY = REGISTRY.register("buny_spawn_egg", () -> new ForgeSpawnEggItem(ChangedAddonEntities.BUNY, Color3.getColor("#fee9c8").toInt(), Color3.getColor("#9c8c73").toInt(), new Item.Properties().tab(ChangedAddonTabs.CHANGED_ADDON_MAIN_TAB)));
    ...
    public static final RegistryObject<Item> MIRROR_WHITE_TIGER = REGISTRY.register("mirror_white_tiger_spawn_egg", () -> new ForgeSpawnEggItem(ChangedAddonEntities.MIRROR_WHITE_TIGER, Color3.getColor("#FFFFFF").toInt(), Color3.getColor("#ACACAC").toInt(), new Item.Properties().tab(ChangedAddonTabs.CHANGED_ADDON_MAIN_TAB)));
    ...
    public static final RegistryObject<Item> REYN_TRANSFUR_SPAWN_EGG = REGISTRY.register("reyn_spawn_egg", () -> new ForgeSpawnEggItem(ChangedAddonEntities.REYN, Color3.getColor("#4C4C4C").toInt(), Color3.getColor("#464646").toInt(), new Item.Properties().tab(ChangedAddonTabs.CHANGED_ADDON_MAIN_TAB)));
    ...
    public static final RegistryObject<Item> LATEX_CALICO_CAT_MALE_SPAWN_EGG = REGISTRY.register("latex_calico_cat_spawn_egg", () -> new ForgeSpawnEggItem(ChangedAddonEntities.LATEX_CALICO_CAT, 0xffece4, 0xd56f53, new Item.Properties().tab(ChangedAddonTabs.CHANGED_ADDON_MAIN_TAB)));
    ...
    public static final RegistryObject<Item> PROTOGEN_0SENIA0_SPAWN_EGG = REGISTRY.register("protogen_0senia0_spawn_egg", () -> new ForgeSpawnEggItem(ChangedAddonEntities.PROTOGEN_0SENIA0, Color3.getColor("#4d0ddb").toInt(), Color3.getColor("#4d0ddb").toInt(), new Item.Properties().tab(ChangedAddonTabs.CHANGED_ADDON_MAIN_TAB)));
