...
public class ChangedAddonGameRules {
    ...
    public static final GameRules.Key<GameRules.BooleanValue> RESPAWN_AS_TRANSFUR = register("respawnAsTransfur", GameRules.Category.PLAYER, GameRules.BooleanValue.create(false));
