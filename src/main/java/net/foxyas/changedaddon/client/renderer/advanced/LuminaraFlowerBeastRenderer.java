...
public class LuminaraFlowerBeastRenderer extends AdvancedHumanoidRenderer<LuminaraFlowerBeastEntity, LuminaraFlowerBeastModel, ArmorLatexMaleWingedDragonModel<LuminaraFlowerBeastEntity>> {
    ...
    public LuminaraFlowerBeastRenderer(EntityRendererProvider.Context context) {
        super(context, new LuminaraFlowerBeastModel(context.bakeLayer(LuminaraFlowerBeastModel.LAYER_LOCATION)), ArmorLatexMaleWingedDragonModel.MODEL_SET, 0.5F);
