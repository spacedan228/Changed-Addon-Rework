...
public class Exp2FemaleRenderer extends AdvancedHumanoidRenderer<Exp2FemaleEntity, FemaleExp2Model> {
    ...
    public @NotNull ResourceLocation getTextureLocation(Exp2FemaleEntity entity) {
        if (entity.getUnderlyingPlayer() == null) {
            return ResourceLocation.parse("changed_addon:textures/entities/female_exp2_snow_leopard.png");
        }

        if (entity.getUnderlyingPlayer() != null && entity.getHealth() / entity.getMaxHealth() <= 0.60 && entity.getHealth() / entity.getMaxHealth() > 0.30) {
            return ResourceLocation.parse("changed_addon:textures/entities/female_exp2_snow_leopard_hurt.png");
        }
        if (entity.getUnderlyingPlayer() != null && entity.getHealth() / entity.getMaxHealth() <= 0.30) {
            return ResourceLocation.parse("changed_addon:textures/entities/female_exp2_snow_leopard_badly_hurt.png");
        }
