...
public class LatexWindCatMaleRenderer extends AdvancedHumanoidRenderer<LatexWindCatMaleEntity, LatexWindCatMaleModel, ArmorLatexMaleWolfModel<LatexWindCatMaleEntity>> {
    ...
    public LatexWindCatMaleRenderer(EntityRendererProvider.Context context) {
        super(context, new LatexWindCatMaleModel(context.bakeLayer(LatexWindCatMaleModel.LAYER_LOCATION)), ArmorLatexMaleWolfModel.MODEL_SET, 0.5F);
