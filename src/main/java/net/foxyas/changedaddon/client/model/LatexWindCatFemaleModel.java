...
public class LatexWindCatFemaleModel extends AdvancedHumanoidModel<LatexWindCatFemaleEntity> implements AdvancedHumanoidModelInterface<LatexWindCatFemaleEntity, LatexWindCatFemaleModel> {
    ...
    private final HumanoidAnimator<LatexWindCatFemaleEntity, LatexWindCatFemaleModel> animator;

    public LatexWindCatFemaleModel(ModelPart root) {
        super(root);
    ...
    @Override
    public void setupAnim(@NotNull LatexWindCatFemaleEntity entity, float limbSwing, float limbSwingAmount, float ageInTicks, float netHeadYaw, float headPitch) {
    ...
    public static LayerDefinition createBodyLayer() {
        ...
        PartDefinition RightThigh_r1 = RightLeg.addOrReplaceChild("RightThigh_r1", CubeListBuilder.create().texOffs(0, 48).addBox(-2.0F, 0.0F, -2.0F, 4.0F, 7.0F, 4.0F, new CubeDeformation(0.1F)), PartPose.offsetAndRotation(0.0F, 0.0F, 0.0F, -0.2182F, 0.0F, 0.0F));
        ...
        PartDefinition LeftThigh_r1 = LeftLeg.addOrReplaceChild("LeftThigh_r1", CubeListBuilder.create().texOffs(32, 44).addBox(-2.0F, 0.0F, -2.0F, 4.0F, 7.0F, 4.0F, new CubeDeformation(0.1F)), PartPose.offsetAndRotation(0.0F, 0.0F, 0.0F, -0.2182F, 0.0F, 0.0F));
        ...
        PartDefinition Hair = Head.addOrReplaceChild("Hair", CubeListBuilder.create().texOffs(8, 77).addBox(-4.0F, -33.0F, -4.0F, 8.0F, 11.0F, 8.0F, new CubeDeformation(0.2F))
                .texOffs(40, 78).addBox(-4.0F, -33.0F, -4.0F, 8.0F, 10.0F, 8.0F, new CubeDeformation(0.35F)), PartPose.offset(0.0F, 25.0F, 0.0F));
        PartDefinition Torso = partdefinition.addOrReplaceChild("Torso", CubeListBuilder.create().texOffs(28, 28).addBox(-4.0F, 0.5F, -2.0F, 8.0F, 5.0F, 4.0F, new CubeDeformation(0.0F))
                .texOffs(71, 29).addBox(-4.0F, 4.5F, -2.0F, 8.0F, 6.0F, 4.0F, new CubeDeformation(-0.3F))
        ...
        PartDefinition RightArm = partdefinition.addOrReplaceChild("RightArm", CubeListBuilder.create().texOffs(0, 32).addBox(-3.0F, -1.5F, -2.0F, 4.0F, 12.0F, 4.0F, new CubeDeformation(0.0F)), PartPose.offset(-5.0F, 1.5F, 0.0F));
        PartDefinition Fur_r8 = RightArm.addOrReplaceChild("Fur_r8", CubeListBuilder.create().texOffs(72, 1).mirror().addBox(0.0F, -4.0F, -2.0F, 1.0F, 4.0F, 3.0F, new CubeDeformation(0.0F)).mirror(false), PartPose.offsetAndRotation(-3.0F, 5.5F, 0.5F, 0.0F, 0.0F, -0.1745F));
    ...
    @Override
    public void prepareMobModel(@NotNull LatexWindCatFemaleEntity pEntity, float pLimbSwing, float pLimbSwingAmount, float pPartialTick) {
    ...
    @Override
    public void setupHand(LatexWindCatFemaleEntity changedEntity) {
        animator.setupHand();
    }

    @Override
    public HumanoidAnimator<LatexWindCatFemaleEntity, LatexWindCatFemaleModel> getAnimator(LatexWindCatFemaleEntity changedEntity) {
        return animator;
    }
}
