...
public class FoxtaFoxyModel extends AdvancedHumanoidModel<FoxtaFoxyEntity> {
    ...
    private final HumanoidAnimator<FoxtaFoxyEntity, FoxtaFoxyModel> animator;

    public FoxtaFoxyModel(ModelPart root) {
        super(root);
    ...
    public void setupAnim(@NotNull FoxtaFoxyEntity entity, float limbSwing, float limbSwingAmount, float ageInTicks, float netHeadYaw, float headPitch) {
