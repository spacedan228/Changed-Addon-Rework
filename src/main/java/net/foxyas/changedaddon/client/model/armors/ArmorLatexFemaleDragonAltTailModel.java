...
public class ArmorLatexFemaleDragonAltTailModel<T extends ChangedEntity> extends LatexHumanoidArmorModel<T, ArmorLatexFemaleDragonAltTailModel<T>> {
    ...
    private final HumanoidAnimator<T, ArmorLatexFemaleDragonAltTailModel<T>> animator;

    public ArmorLatexFemaleDragonAltTailModel(ModelPart modelPart, ArmorModel model) {
    ...
    @Override
    public HumanoidAnimator<T, ArmorLatexFemaleDragonAltTailModel<T>> getAnimator(T entity) {
        return animator;
    }
