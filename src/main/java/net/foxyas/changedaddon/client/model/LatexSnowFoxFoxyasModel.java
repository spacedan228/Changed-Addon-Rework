...
public class LatexSnowFoxFoxyasModel extends AdvancedHumanoidModel<LatexSnowFoxFoxyasEntity> implements AdvancedHumanoidModelInterface<LatexSnowFoxFoxyasEntity, LatexSnowFoxFoxyasModel> {
    ...
    private final HumanoidAnimator<LatexSnowFoxFoxyasEntity, LatexSnowFoxFoxyasModel> animator;

    public LatexSnowFoxFoxyasModel(ModelPart root) {
        super(root);
    ...
    public static LayerDefinition createBodyLayer() {
        ...
        PartDefinition RightArm = partdefinition.addOrReplaceChild("RightArm", CubeListBuilder.create().texOffs(16, 40).addBox(-2.0F, -2.0F, -2.0F, 3.0F, 12.0F, 4.0F, new CubeDeformation(0.0F)), PartPose.offset(-5.0F, 1.5F, 0.0F));

        PartDefinition RightArmPawBeans = RightArm.addOrReplaceChild("RightArmPawBeans", CubeListBuilder.create().texOffs(27, 93).mirror().addBox(-2.0F, 9.575F, -0.375F, 2.0F, 1.0F, 2.0F, new CubeDeformation(-0.05F)).mirror(false)
                .texOffs(27, 89).mirror().addBox(-2.5F, 9.575F, -1.425F, 1.0F, 1.0F, 1.0F, new CubeDeformation(-0.05F)).mirror(false)
                .texOffs(27, 87).mirror().addBox(-1.525F, 9.575F, -1.875F, 1.0F, 1.0F, 1.0F, new CubeDeformation(-0.05F)).mirror(false)
                .texOffs(27, 91).mirror().addBox(-0.525F, 9.575F, -1.425F, 1.0F, 1.0F, 1.0F, new CubeDeformation(-0.05F)).mirror(false), PartPose.offset(0.5F, -0.5F, 0.0F));
        ...
        PartDefinition RightArmFur_r2 = RightArmFur.addOrReplaceChild("RightArmFur_r2", CubeListBuilder.create().texOffs(0, 86).mirror().addBox(-1.0F, -3.0F, 0.025F, 4.0F, 4.0F, 1.0F, new CubeDeformation(-0.25F)).mirror(false), PartPose.offsetAndRotation(-0.3F, 0.0F, 3.4F, 0.0F, 1.5708F, -0.0873F));

        PartDefinition RightArmFur_r3 = RightArmFur.addOrReplaceChild("RightArmFur_r3", CubeListBuilder.create().texOffs(1, 81).mirror().addBox(0.0F, -3.0F, 0.025F, 3.0F, 4.0F, 1.0F, new CubeDeformation(-0.25F)).mirror(false), PartPose.offsetAndRotation(0.0F, 0.0F, 3.7F, -0.0873F, 0.0F, 0.0F));

        PartDefinition RightArmFur_r4 = RightArmFur.addOrReplaceChild("RightArmFur_r4", CubeListBuilder.create().texOffs(1, 76).mirror().addBox(0.0F, -3.0F, 0.025F, 3.0F, 4.0F, 1.0F, new CubeDeformation(-0.25F)).mirror(false), PartPose.offsetAndRotation(0.0F, 0.0F, 0.1F, 0.0873F, 0.0F, 0.0F));

        PartDefinition LeftArm = partdefinition.addOrReplaceChild("LeftArm", CubeListBuilder.create().texOffs(1, 40).addBox(-1.0F, -2.0F, -2.0F, 3.0F, 12.0F, 4.0F, new CubeDeformation(0.0F)), PartPose.offset(5.0F, 1.5F, 0.0F));

        PartDefinition LeftArmPawBeans = LeftArm.addOrReplaceChild("LeftArmPawBeans", CubeListBuilder.create().texOffs(35, 93).addBox(0.0F, 9.575F, -0.375F, 2.0F, 1.0F, 2.0F, new CubeDeformation(-0.05F))
                .texOffs(35, 89).addBox(1.5F, 9.575F, -1.425F, 1.0F, 1.0F, 1.0F, new CubeDeformation(-0.05F))
                .texOffs(35, 87).addBox(0.525F, 9.575F, -1.875F, 1.0F, 1.0F, 1.0F, new CubeDeformation(-0.05F))
                .texOffs(35, 91).addBox(-0.475F, 9.575F, -1.425F, 1.0F, 1.0F, 1.0F, new CubeDeformation(-0.05F)), PartPose.offset(-0.5F, -0.5F, 0.0F));

        PartDefinition LeftArmFur = LeftArm.addOrReplaceChild("LeftArmFur", CubeListBuilder.create(), PartPose.offset(1.3F, 7.5F, -2.4F));

        PartDefinition LeftArmFur_r1 = LeftArmFur.addOrReplaceChild("LeftArmFur_r1", CubeListBuilder.create().texOffs(0, 71).mirror().addBox(-1.0F, -3.0F, 0.025F, 4.0F, 4.0F, 1.0F, new CubeDeformation(-0.25F)).mirror(false), PartPose.offsetAndRotation(-2.6F, 0.0F, 3.4F, 0.0F, 1.5708F, -0.0873F));

        PartDefinition LeftArmFur_r2 = LeftArmFur.addOrReplaceChild("LeftArmFur_r2", CubeListBuilder.create().texOffs(0, 66).addBox(-3.0F, -3.0F, 0.025F, 4.0F, 4.0F, 1.0F, new CubeDeformation(-0.25F)), PartPose.offsetAndRotation(1.0F, 0.0F, 3.4F, 0.0F, -1.5708F, 0.0873F));

        PartDefinition LeftArmFur_r3 = LeftArmFur.addOrReplaceChild("LeftArmFur_r3", CubeListBuilder.create().texOffs(0, 61).addBox(-3.0F, -3.0F, 0.025F, 3.0F, 4.0F, 1.0F, new CubeDeformation(-0.25F)), PartPose.offsetAndRotation(0.7F, 0.0F, 3.7F, -0.0873F, 0.0F, 0.0F));

        PartDefinition LeftArmFur_r4 = LeftArmFur.addOrReplaceChild("LeftArmFur_r4", CubeListBuilder.create().texOffs(0, 56).addBox(-3.0F, -3.0F, 0.025F, 3.0F, 4.0F, 1.0F, new CubeDeformation(-0.25F)), PartPose.offsetAndRotation(0.7F, 0.0F, 0.1F, 0.0873F, 0.0F, 0.0F));
  ...
  */
    @Override
    public void setupHand(LatexSnowFoxFoxyasEntity entity) {
        animator.setupHand();
    }


    @Override
    public void setupAnim(@NotNull LatexSnowFoxFoxyasEntity entity, float limbSwing, float limbSwingAmount, float ageInTicks, float netHeadYaw, float headPitch) {
    ...
    @Override
    public HumanoidAnimator<LatexSnowFoxFoxyasEntity, LatexSnowFoxFoxyasModel> getAnimator(LatexSnowFoxFoxyasEntity entity) {
        return animator;
    }
}
