...
public class LatexWindCatMaleModel extends AdvancedHumanoidModel<LatexWindCatMaleEntity> {
    ...
    private final HumanoidAnimator<LatexWindCatMaleEntity, LatexWindCatMaleModel> animator;

    public LatexWindCatMaleModel(ModelPart root) {
        super(root);
    ...
    public static LayerDefinition createBodyLayer() {
        ...
        PartDefinition Fur_r1 = RightEar.addOrReplaceChild("Fur_r1", CubeListBuilder.create().texOffs(25, 66).mirror().addBox(0.0F, -4.0F, -2.0F, 0.0F, 4.0F, 4.0F, new CubeDeformation(0.0F)).mirror(false), PartPose.offsetAndRotation(-2.25F, -6.25F, 2.75F, 0.5604F, -0.2494F, -0.3155F));
        ...
        PartDefinition Fur_r2 = LeftEar.addOrReplaceChild("Fur_r2", CubeListBuilder.create().texOffs(33, 66).addBox(0.0F, -4.0F, -2.0F, 0.0F, 4.0F, 4.0F, new CubeDeformation(0.0F)), PartPose.offsetAndRotation(2.25F, -6.25F, 2.75F, 0.5604F, 0.2494F, 0.3155F));
    ...
    @Override
    public void setupHand(LatexWindCatMaleEntity changedEntity) {
        animator.setupHand();
    }

    @Override
    public HumanoidAnimator<LatexWindCatMaleEntity, LatexWindCatMaleModel> getAnimator(LatexWindCatMaleEntity changedEntity) {
        return animator;
    }
}
