...
public class LuminarcticLeopardMaleModel extends AdvancedHumanoidModel<LuminarcticLeopardMaleEntity> {
    ...
    @Override
    public void prepareMobModel(@NotNull LuminarcticLeopardMaleEntity p_162861, float p_102862, float p_102863, float p_102864_) {
    ...
    @Override
    public void setupAnim(@NotNull LuminarcticLeopardMaleEntity entity, float limbSwing, float limbSwingAmount, float ageInTicks, float netHeadYaw, float headPitch) {
