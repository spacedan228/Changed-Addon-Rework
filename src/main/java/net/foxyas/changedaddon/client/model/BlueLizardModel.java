...
public class BlueLizardModel extends AdvancedHumanoidModel<BlueLizard> {
    public static final ModelLayerLocation LAYER_LOCATION = ChangedAddonMod.layerLocation(("blue_lizard"), "main");
    ...
    public void prepareMobModel(@NotNull BlueLizard p_102861_, float p_102862_, float p_102863_, float p_102864_) {
        super.prepareMobModel(p_102861_, p_102862_, p_102863_, p_102864_);
    }

    public void setupHand(BlueLizard entity) {
    ...
    public HumanoidAnimator<BlueLizard, BlueLizardModel> getAnimator(BlueLizard entity) {
