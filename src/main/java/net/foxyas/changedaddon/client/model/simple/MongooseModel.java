...
public class MongooseModel extends AdvancedHumanoidModel<MongooseEntity> {
    ...
    public static LayerDefinition createBodyLayer() {
        ...
        PartDefinition Fur_r1 = Head.addOrReplaceChild("Fur_r1", CubeListBuilder.create().texOffs(70, 0).mirror().addBox(0.0F, -5.0F, 0.0F, 1.0F, 4.0F, 2.0F, new CubeDeformation(0.25F)).mirror(false), PartPose.offsetAndRotation(-3.75F, -1.0F, -1.0F, 0.0F, -0.5672F, 0.0F));

        PartDefinition Fur_r2 = Head.addOrReplaceChild("Fur_r2", CubeListBuilder.create().texOffs(64, 0).addBox(-1.0F, -5.0F, 0.0F, 1.0F, 4.0F, 2.0F, new CubeDeformation(0.25F)), PartPose.offsetAndRotation(3.75F, -1.0F, -1.0F, 0.0F, 0.5672F, 0.0F));
        ...
        PartDefinition rightear_r1 = RightEar.addOrReplaceChild("rightear_r1", CubeListBuilder.create().texOffs(0, 59).mirror().addBox(-4.25F, -34.0F, -11.25F, 2.0F, 4.0F, 4.0F, new CubeDeformation(-0.25F)).mirror(false), PartPose.offsetAndRotation(2.5F, 30.0F, 0.0F, -0.733F, -1.3439F, 0.384F));

        PartDefinition LeftEar = Head.addOrReplaceChild("LeftEar", CubeListBuilder.create(), PartPose.offset(2.5F, -5.0F, 0.0F));

        PartDefinition leftear_r1 = LeftEar.addOrReplaceChild("leftear_r1", CubeListBuilder.create().texOffs(16, 32).addBox(2.25F, -34.0F, -11.25F, 2.0F, 4.0F, 4.0F, new CubeDeformation(-0.25F)), PartPose.offsetAndRotation(-2.5F, 30.0F, 0.0F, -0.733F, 1.3439F, -0.384F));
        ...
        PartDefinition Fur_r3 = Torso.addOrReplaceChild("Fur_r3", CubeListBuilder.create().texOffs(76, 0).mirror().addBox(-4.5F, -3.0F, 0.0F, 8.0F, 3.0F, 1.0F, new CubeDeformation(0.0F)).mirror(false), PartPose.offsetAndRotation(-0.5F, 0.0F, -2.0F, 0.2182F, 0.0F, -3.1416F));

        PartDefinition Fur_r4 = Torso.addOrReplaceChild("Fur_r4", CubeListBuilder.create().texOffs(77, 4).mirror().addBox(-3.5F, -2.0F, -0.1F, 7.0F, 2.0F, 1.0F, new CubeDeformation(-0.25F)).mirror(false), PartPose.offsetAndRotation(0.0F, 3.75F, -2.0F, 0.3491F, 0.0F, 0.0F));

        PartDefinition Tail = Torso.addOrReplaceChild("Tail", CubeListBuilder.create(), PartPose.offset(0.0F, 10.5F, 0.0F));

        PartDefinition TailPrimary = Tail.addOrReplaceChild("TailPrimary", CubeListBuilder.create(), PartPose.offsetAndRotation(0.0F, 0.0F, 0.0F, 0.1309F, 0.0F, 0.0F));

        PartDefinition Base_r1 = TailPrimary.addOrReplaceChild("Base_r1", CubeListBuilder.create().texOffs(28, 55).addBox(-2.0F, 0.75F, -1.4F, 4.0F, 5.0F, 4.0F, new CubeDeformation(-0.3F)), PartPose.offsetAndRotation(0.0F, 0.0F, 0.0F, 1.0908F, 0.0F, 0.0F));

        PartDefinition TailSecondary = TailPrimary.addOrReplaceChild("TailSecondary", CubeListBuilder.create(), PartPose.offset(0.0F, 1.25F, 4.5F));

        PartDefinition Base_r2 = TailSecondary.addOrReplaceChild("Base_r2", CubeListBuilder.create().texOffs(48, 22).addBox(-2.0F, -0.25F, -1.9F, 4.0F, 6.0F, 4.0F, new CubeDeformation(-0.1F)), PartPose.offsetAndRotation(0.0F, 0.5F, 0.0F, 1.3526F, 0.0F, 0.0F));
        ...
        PartDefinition Base_r3 = TailTertiary.addOrReplaceChild("Base_r3", CubeListBuilder.create().texOffs(48, 0).addBox(-2.0F, 5.05F, -2.8F, 4.0F, 7.0F, 4.0F, new CubeDeformation(0.0F)), PartPose.offsetAndRotation(0.0F, -0.25F, -4.5F, 1.5184F, 0.0F, 0.0F));
