...
public class FemaleExp2Model extends AdvancedHumanoidModel<Exp2FemaleEntity> {
    ...
    public static LayerDefinition createBodyLayer() {
        ...
        PartDefinition RightFur = RightArm.addOrReplaceChild("RightFur", CubeListBuilder.create().texOffs(33, 75).addBox(-3.0F, -2.0F, -2.0F, 4.0F, 9.0F, 4.0F, new CubeDeformation(0.15F)), PartPose.offset(0.0F, 0.0F, 0.0F));
        ...
        PartDefinition LeftFur = LeftArm.addOrReplaceChild("LeftFur", CubeListBuilder.create().texOffs(50, 75).mirror().addBox(-1.0F, -2.0F, -2.0F, 4.0F, 9.0F, 4.0F, new CubeDeformation(0.15F)).mirror(false), PartPose.offset(0.0F, 0.0F, 0.0F));
    ...
    @Override
    public void prepareMobModel(@NotNull Exp2FemaleEntity p_162861, float p_102862, float p_102863, float p_102864_) {
