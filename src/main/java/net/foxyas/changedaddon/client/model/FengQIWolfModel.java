...
import net.foxyas.changedaddon.entity.simple.FengQIWolfEntity;
...
public class FengQIWolfModel extends AdvancedHumanoidModel<FengQIWolfEntity> {
    ...
    @Override
    public void setupHand(FengQIWolfEntity entity) {
    ...
    public HumanoidAnimator<FengQIWolfEntity, FengQIWolfModel> getAnimator(FengQIWolfEntity entity) {
