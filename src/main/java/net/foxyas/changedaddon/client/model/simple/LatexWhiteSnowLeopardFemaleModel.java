...
public class LatexWhiteSnowLeopardFemaleModel extends AdvancedHumanoidModel<LatexWhiteSnowLeopardFemale> implements AdvancedHumanoidModelInterface<LatexWhiteSnowLeopardFemale, LatexWhiteSnowLeopardFemaleModel> {
    // This layer location should be baked with EntityRendererProvider.Context in the entity renderer and passed into this model's constructor
    public static final ModelLayerLocation LAYER_LOCATION = new ModelLayerLocation(Changed.modResource("latex_white_snow_leopard_female"), "main");
    ...
    private final HumanoidAnimator<LatexWhiteSnowLeopardFemale, LatexWhiteSnowLeopardFemaleModel> animator;

    public LatexWhiteSnowLeopardFemaleModel(ModelPart root) {
        super(root);
    ...
    @Override
    public void prepareMobModel(@NotNull LatexWhiteSnowLeopardFemale p_102861_, float p_102862_, float p_102863_, float p_102864_) {
        this.prepareMobModel(animator, p_102861_, p_102862_, p_102863_, p_102864_);
    }

    public void setupHand(LatexWhiteSnowLeopardFemale entity) {
        animator.setupHand();
    }

    @Override
    public void setupAnim(@NotNull LatexWhiteSnowLeopardFemale entity, float limbSwing, float limbSwingAmount, float ageInTicks, float netHeadYaw, float headPitch) {
    ...
    @Override
    public HumanoidAnimator<LatexWhiteSnowLeopardFemale, LatexWhiteSnowLeopardFemaleModel> getAnimator(LatexWhiteSnowLeopardFemale entity) {
        return animator;
    }
}