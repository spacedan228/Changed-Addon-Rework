...
public class LatexSnepModel extends AdvancedHumanoidModel<LatexSnepEntity> implements AdvancedHumanoidModelInterface<LatexSnepEntity, LatexSnepModel> {
    ...
    public static LayerDefinition createBodyLayer() {
        ...
        PartDefinition Head = Animal.addOrReplaceChild("Head", CubeListBuilder.create().texOffs(0, 0).addBox(-2.5F, -2.0F, -3.0F, 5.0F, 4.0F, 5.0F, new CubeDeformation(0.5F))
                .texOffs(0, 24).addBox(-1.5F, -0.02F, -4.75F, 3.0F, 2.0F, 2.0F, new CubeDeformation(0.05F))
                .texOffs(14, 23).addBox(-2.75F, -4.5F, -0.75F, 2.0F, 2.0F, 3.0F, new CubeDeformation(0.0F))
                .texOffs(25, 24).addBox(0.75F, -4.5F, -0.75F, 2.0F, 2.0F, 3.0F, new CubeDeformation(0.0F)), PartPose.offset(0.0F, -10.0F, -8.25F));
        ...
        PartDefinition NewRightPawBeans = RightArm.addOrReplaceChild("NewRightPawBeans", CubeListBuilder.create(), PartPose.offset(-0.5F, 6.025F, -1.1F));

        PartDefinition MiddlePawBeans2 = NewRightPawBeans.addOrReplaceChild("MiddlePawBeans2", CubeListBuilder.create().texOffs(8, 83).mirror().addBox(-0.9F, -0.6169F, -0.4895F, 1.0F, 1.0F, 1.0F, new CubeDeformation(-0.4F)).mirror(false)
                .texOffs(8, 83).mirror().addBox(-0.8F, -0.617F, -0.615F, 1.0F, 1.0F, 1.0F, new CubeDeformation(-0.4F)).mirror(false)
                .texOffs(8, 83).mirror().addBox(-0.7F, -0.6167F, -0.6145F, 1.0F, 1.0F, 1.0F, new CubeDeformation(-0.4F)).mirror(false)
                .texOffs(8, 83).mirror().addBox(-0.5F, -0.6167F, -0.6145F, 1.0F, 1.0F, 1.0F, new CubeDeformation(-0.4F)).mirror(false)
                .texOffs(8, 83).mirror().addBox(-0.3F, -0.6167F, -0.6145F, 1.0F, 1.0F, 1.0F, new CubeDeformation(-0.4F)).mirror(false)
                .texOffs(8, 83).mirror().addBox(-0.2F, -0.617F, -0.615F, 1.0F, 1.0F, 1.0F, new CubeDeformation(-0.4F)).mirror(false)
                .texOffs(8, 83).mirror().addBox(-0.1F, -0.6169F, -0.4895F, 1.0F, 1.0F, 1.0F, new CubeDeformation(-0.4F)).mirror(false)
                .texOffs(9, 88).mirror().addBox(-1.0F, -0.6168F, -0.3645F, 2.0F, 1.0F, 1.0F, new CubeDeformation(-0.4F)).mirror(false)
                .texOffs(9, 88).mirror().addBox(-1.0F, -0.7157F, -0.1145F, 2.0F, 1.0F, 1.0F, new CubeDeformation(-0.3F)).mirror(false)
                .texOffs(8, 83).mirror().addBox(-0.3F, -0.6169F, -0.4895F, 1.0F, 1.0F, 1.0F, new CubeDeformation(-0.4F)).mirror(false)
                .texOffs(8, 83).mirror().addBox(-0.5F, -0.6169F, -0.4895F, 1.0F, 1.0F, 1.0F, new CubeDeformation(-0.4F)).mirror(false)
                .texOffs(8, 83).mirror().addBox(-0.7F, -0.6169F, -0.4895F, 1.0F, 1.0F, 1.0F, new CubeDeformation(-0.4F)).mirror(false), PartPose.offset(0.0F, 0.0417F, 0.4645F));

        PartDefinition PawBeans2 = NewRightPawBeans.addOrReplaceChild("PawBeans2", CubeListBuilder.create().texOffs(8, 83).mirror().addBox(-1.96F, -0.624F, -0.5F, 1.0F, 1.0F, 1.0F, new CubeDeformation(-0.325F)).mirror(false)
                .texOffs(8, 79).mirror().addBox(-1.53F, -0.624F, -0.925F, 1.0F, 1.0F, 1.0F, new CubeDeformation(-0.3F)).mirror(false)
                .texOffs(8, 81).mirror().addBox(-0.93F, -0.624F, -0.925F, 1.0F, 1.0F, 1.0F, new CubeDeformation(-0.3F)).mirror(false)
                .texOffs(8, 85).addBox(-0.5F, -0.624F, -0.5F, 1.0F, 1.0F, 1.0F, new CubeDeformation(-0.325F)), PartPose.offset(0.73F, -0.05F, 0.225F));
        ...
        PartDefinition NewLeftPawBeans = LeftArm.addOrReplaceChild("NewLeftPawBeans", CubeListBuilder.create(), PartPose.offset(0.5F, 5.775F, -0.85F));

        PartDefinition MiddlePawBeans = NewLeftPawBeans.addOrReplaceChild("MiddlePawBeans", CubeListBuilder.create().texOffs(8, 83).addBox(-0.1F, -0.6169F, -0.4895F, 1.0F, 1.0F, 1.0F, new CubeDeformation(-0.4F))
                .texOffs(8, 83).addBox(-0.2F, -0.617F, -0.615F, 1.0F, 1.0F, 1.0F, new CubeDeformation(-0.4F))
                .texOffs(8, 83).addBox(-0.3F, -0.6167F, -0.6145F, 1.0F, 1.0F, 1.0F, new CubeDeformation(-0.4F))
                .texOffs(8, 83).addBox(-0.5F, -0.6167F, -0.6145F, 1.0F, 1.0F, 1.0F, new CubeDeformation(-0.4F))
                .texOffs(8, 83).addBox(-0.7F, -0.6167F, -0.6145F, 1.0F, 1.0F, 1.0F, new CubeDeformation(-0.4F))
                .texOffs(8, 83).addBox(-0.8F, -0.617F, -0.615F, 1.0F, 1.0F, 1.0F, new CubeDeformation(-0.4F))
                .texOffs(8, 83).addBox(-0.9F, -0.6169F, -0.4895F, 1.0F, 1.0F, 1.0F, new CubeDeformation(-0.4F))
                .texOffs(9, 88).addBox(-1.0F, -0.6168F, -0.3645F, 2.0F, 1.0F, 1.0F, new CubeDeformation(-0.4F))
                .texOffs(9, 88).addBox(-1.0F, -0.7157F, -0.1145F, 2.0F, 1.0F, 1.0F, new CubeDeformation(-0.3F))
                .texOffs(8, 83).addBox(-0.7F, -0.6169F, -0.4895F, 1.0F, 1.0F, 1.0F, new CubeDeformation(-0.4F))
                .texOffs(8, 83).addBox(-0.5F, -0.6169F, -0.4895F, 1.0F, 1.0F, 1.0F, new CubeDeformation(-0.4F))
                .texOffs(8, 83).addBox(-0.3F, -0.6169F, -0.4895F, 1.0F, 1.0F, 1.0F, new CubeDeformation(-0.4F)), PartPose.offset(0.0F, 0.0417F, 0.4645F));

        PartDefinition PawBeans = NewLeftPawBeans.addOrReplaceChild("PawBeans", CubeListBuilder.create().texOffs(8, 85).addBox(0.96F, -0.624F, -0.5F, 1.0F, 1.0F, 1.0F, new CubeDeformation(-0.325F))
                .texOffs(8, 79).addBox(0.53F, -0.624F, -0.925F, 1.0F, 1.0F, 1.0F, new CubeDeformation(-0.3F))
                .texOffs(8, 81).addBox(-0.07F, -0.624F, -0.925F, 1.0F, 1.0F, 1.0F, new CubeDeformation(-0.3F))
                .texOffs(8, 83).mirror().addBox(-0.5F, -0.624F, -0.5F, 1.0F, 1.0F, 1.0F, new CubeDeformation(-0.325F)).mirror(false), PartPose.offset(-0.73F, -0.05F, 0.225F));
        ...
        PartDefinition RightCalf_r1 = RightLowerLeg.addOrReplaceChild("RightCalf_r1", CubeListBuilder.create().texOffs(0, 28).addBox(-0.74F, -0.625F, -2.15F, 2.0F, 4.0F, 2.0F, new CubeDeformation(0.0F)), PartPose.offsetAndRotation(0.0F, -3.125F, 1.95F, 0.8727F, 0.0F, 0.0F));
        ...
        PartDefinition NewBackRightPawBeans = LegBackRight.addOrReplaceChild("NewBackRightPawBeans", CubeListBuilder.create(), PartPose.offset(-0.25F, 6.025F, -0.6F));

        PartDefinition MiddlePawBeans3 = NewBackRightPawBeans.addOrReplaceChild("MiddlePawBeans3", CubeListBuilder.create().texOffs(8, 83).mirror().addBox(-0.9F, -0.6169F, -0.4895F, 1.0F, 1.0F, 1.0F, new CubeDeformation(-0.4F)).mirror(false)
                .texOffs(8, 83).mirror().addBox(-0.8F, -0.617F, -0.615F, 1.0F, 1.0F, 1.0F, new CubeDeformation(-0.4F)).mirror(false)
                .texOffs(8, 83).mirror().addBox(-0.7F, -0.6167F, -0.6145F, 1.0F, 1.0F, 1.0F, new CubeDeformation(-0.4F)).mirror(false)
                .texOffs(8, 83).mirror().addBox(-0.5F, -0.6167F, -0.6145F, 1.0F, 1.0F, 1.0F, new CubeDeformation(-0.4F)).mirror(false)
                .texOffs(8, 83).mirror().addBox(-0.3F, -0.6167F, -0.6145F, 1.0F, 1.0F, 1.0F, new CubeDeformation(-0.4F)).mirror(false)
        ...
        PartDefinition PawBeans3 = NewBackRightPawBeans.addOrReplaceChild("PawBeans3", CubeListBuilder.create().texOffs(8, 83).mirror().addBox(-1.96F, -0.624F, -0.5F, 1.0F, 1.0F, 1.0F, new CubeDeformation(-0.325F)).mirror(false)
                .texOffs(8, 79).mirror().addBox(-1.53F, -0.624F, -0.925F, 1.0F, 1.0F, 1.0F, new CubeDeformation(-0.3F)).mirror(false)
                .texOffs(8, 81).mirror().addBox(-0.93F, -0.624F, -0.925F, 1.0F, 1.0F, 1.0F, new CubeDeformation(-0.3F)).mirror(false)
                .texOffs(8, 85).addBox(-0.5F, -0.624F, -0.5F, 1.0F, 1.0F, 1.0F, new CubeDeformation(-0.325F)), PartPose.offset(0.73F, -0.05F, 0.225F));
        ...
        PartDefinition NewBackLeftPawBeans = LegBackLeft.addOrReplaceChild("NewBackLeftPawBeans", CubeListBuilder.create(), PartPose.offset(0.5F, 6.025F, -0.6F));

        PartDefinition MiddlePawBeans4 = NewBackLeftPawBeans.addOrReplaceChild("MiddlePawBeans4", CubeListBuilder.create().texOffs(8, 83).addBox(-0.1F, -0.6169F, -0.4895F, 1.0F, 1.0F, 1.0F, new CubeDeformation(-0.4F))
                .texOffs(8, 83).addBox(-0.2F, -0.617F, -0.615F, 1.0F, 1.0F, 1.0F, new CubeDeformation(-0.4F))
                .texOffs(8, 83).addBox(-0.3F, -0.6167F, -0.6145F, 1.0F, 1.0F, 1.0F, new CubeDeformation(-0.4F))
                .texOffs(8, 83).addBox(-0.5F, -0.6167F, -0.6145F, 1.0F, 1.0F, 1.0F, new CubeDeformation(-0.4F))
                .texOffs(8, 83).addBox(-0.7F, -0.6167F, -0.6145F, 1.0F, 1.0F, 1.0F, new CubeDeformation(-0.4F))
        ...
        PartDefinition PawBeans4 = NewBackLeftPawBeans.addOrReplaceChild("PawBeans4", CubeListBuilder.create().texOffs(8, 85).addBox(0.96F, -0.624F, -0.5F, 1.0F, 1.0F, 1.0F, new CubeDeformation(-0.325F))
                .texOffs(8, 79).addBox(0.53F, -0.624F, -0.925F, 1.0F, 1.0F, 1.0F, new CubeDeformation(-0.3F))
                .texOffs(8, 81).addBox(-0.07F, -0.624F, -0.925F, 1.0F, 1.0F, 1.0F, new CubeDeformation(-0.3F))
                .texOffs(8, 83).mirror().addBox(-0.5F, -0.624F, -0.5F, 1.0F, 1.0F, 1.0F, new CubeDeformation(-0.325F)).mirror(false), PartPose.offset(-0.73F, -0.05F, 0.225F));
