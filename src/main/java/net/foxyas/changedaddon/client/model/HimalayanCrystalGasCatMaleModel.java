...
public class HimalayanCrystalGasCatMaleModel extends AdvancedHumanoidModel<CrystalGasCatMaleEntity> {
    ...
    public static LayerDefinition createBodyLayer() {
        ...
        PartDefinition rightear_r1 = RightEar.addOrReplaceChild("rightear_r1", CubeListBuilder.create().texOffs(61, 48).addBox(5.5996F, -34.2731F, -1.0F, 2.0F, 4.0F, 3.0F, new CubeDeformation(0.0F)), PartPose.offsetAndRotation(2.5F, 29.5F, 0.0F, 0.0F, 0.0F, -0.3054F));
        ...
        PartDefinition cube_r1 = Right.addOrReplaceChild("cube_r1", CubeListBuilder.create().texOffs(37, 92).addBox(-0.5F, -1.0F, -3.0F, 1.0F, 2.0F, 2.0F, new CubeDeformation(0.0F)), PartPose.offsetAndRotation(-3.9107F, -0.8024F, -0.5F, -1.5708F, -0.4363F, 0.0F));

        PartDefinition cube_r2 = Right.addOrReplaceChild("cube_r2", CubeListBuilder.create().texOffs(37, 92).mirror().addBox(0.25F, -0.75F, -3.0F, 1.0F, 2.0F, 2.0F, new CubeDeformation(-0.1F)).mirror(false), PartPose.offsetAndRotation(-4.5F, 0.3F, -0.5F, -1.5708F, -0.4363F, 0.0F));

        PartDefinition Left = ExtraFur.addOrReplaceChild("Left", CubeListBuilder.create(), PartPose.offset(0.0F, 0.0F, 0.0F));

        PartDefinition cube_r3 = Left.addOrReplaceChild("cube_r3", CubeListBuilder.create().texOffs(37, 92).addBox(-0.5F, -1.0F, -3.0F, 1.0F, 2.0F, 2.0F, new CubeDeformation(0.0F)), PartPose.offsetAndRotation(3.9107F, -0.8024F, -0.5F, -1.5708F, 0.4363F, 0.0F));

        PartDefinition cube_r4 = Left.addOrReplaceChild("cube_r4", CubeListBuilder.create().texOffs(37, 92).addBox(-1.25F, -0.75F, -3.0F, 1.0F, 2.0F, 2.0F, new CubeDeformation(-0.1F)), PartPose.offsetAndRotation(4.5F, 0.3F, -0.5F, -1.5708F, 0.4363F, 0.0F));

        PartDefinition LeftCrystal = Head.addOrReplaceChild("LeftCrystal", CubeListBuilder.create(), PartPose.offset(-1.5F, 24.2F, 0.6F));
        ...
        PartDefinition RightCrystal = Head.addOrReplaceChild("RightCrystal", CubeListBuilder.create(), PartPose.offset(0.0F, 24.2F, 1.0F));
        ...
        PartDefinition NeckFluff = Torso.addOrReplaceChild("NeckFluff", CubeListBuilder.create().texOffs(50, 81).addBox(-3.0F, -0.5F, -3.0F, 6.0F, 4.0F, 1.0F, new CubeDeformation(0.0F))
                .texOffs(50, 86).addBox(-3.0F, 3.5F, -2.5F, 6.0F, 1.0F, 1.0F, new CubeDeformation(0.0F))
                .texOffs(64, 81).addBox(-4.0F, -0.5F, -2.5F, 8.0F, 4.0F, 1.0F, new CubeDeformation(-0.01F))
                .texOffs(50, 77).addBox(-3.0F, -0.5F, 2.0F, 6.0F, 3.0F, 1.0F, new CubeDeformation(0.0F))
                .texOffs(50, 88).addBox(-3.0F, 2.5F, 1.5F, 6.0F, 1.0F, 1.0F, new CubeDeformation(0.0F))
                .texOffs(64, 77).addBox(-4.0F, -0.5F, 1.5F, 8.0F, 3.0F, 1.0F, new CubeDeformation(-0.01F)), PartPose.offset(0.0F, 0.0F, 0.0F));

        PartDefinition RightTuft_r1 = NeckFluff.addOrReplaceChild("RightTuft_r1", CubeListBuilder.create().texOffs(54, 69).addBox(10.5F, -23.5F, -2.5F, 1.0F, 2.0F, 5.0F, new CubeDeformation(0.0F)), PartPose.offsetAndRotation(0.0F, 24.5F, 0.0F, 0.0F, 0.0F, -0.6109F));

        PartDefinition LeftTuft_r1 = NeckFluff.addOrReplaceChild("LeftTuft_r1", CubeListBuilder.create().texOffs(66, 69).addBox(-11.5F, -23.5F, -2.5F, 1.0F, 2.0F, 5.0F, new CubeDeformation(0.0F)), PartPose.offsetAndRotation(0.0F, 24.5F, 0.0F, 0.0F, 0.0F, 0.6109F));
        ...
        PartDefinition RightArmCrystals = RightArm.addOrReplaceChild("RightArmCrystals", CubeListBuilder.create(), PartPose.offset(0.0F, 0.0F, 0.0F));
        ...
        PartDefinition LeftArmCrystals = LeftArm.addOrReplaceChild("LeftArmCrystals", CubeListBuilder.create(), PartPose.offset(-1.0F, 0.0F, 0.0F));
    ...
    public void prepareMobModel(@NotNull CrystalGasCatMaleEntity p_102861_, float p_102862_, float p_102863_, float p_102864_) {
        super.prepareMobModel(p_102861_, p_102862_, p_102863_, p_102864_);
    }

    public void setupHand(CrystalGasCatMaleEntity entity) {
        this.animator.setupHand();
    }

    public void setupAnim(@NotNull CrystalGasCatMaleEntity entity, float limbSwing, float limbSwingAmount, float ageInTicks, float netHeadYaw, float headPitch) {
