...
public class BorealisMaleModel extends AdvancedHumanoidModel<BorealisMaleEntity> {
    ...
    private final HumanoidAnimator<BorealisMaleEntity, BorealisMaleModel> animator;


    public BorealisMaleModel(ModelPart root) {
        super(root);
    ...
    @Override
    public void prepareMobModel(@NotNull BorealisMaleEntity p_162861, float p_102862, float p_102863, float p_102864_) {
        super.prepareMobModel(p_162861, p_102862, p_102863, p_102864_);
    }

    @Override
    public void setupHand(BorealisMaleEntity entity) {
        animator.setupHand();
    }

    @Override
    public void setupAnim(@NotNull BorealisMaleEntity entity, float limbSwing, float limbSwingAmount, float ageInTicks, float netHeadYaw, float headPitch) {
    ...
    @Override
    public HumanoidAnimator<BorealisMaleEntity, BorealisMaleModel> getAnimator(BorealisMaleEntity entity) {
        return animator;
    }
}