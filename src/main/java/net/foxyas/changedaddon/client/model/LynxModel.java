...
public class LynxModel extends AdvancedHumanoidModel<LynxEntity> {
    // This layer location should be baked with EntityRendererProvider.Context in the entity renderer and passed into this model's constructor
    public static final ModelLayerLocation LAYER_LOCATION = ChangedAddonMod.layerLocation(("lynx_model"), "main");
    ...
    @Override
    public void prepareMobModel(@NotNull LynxEntity p_162861, float p_102862, float p_102863, float p_102864_) {
