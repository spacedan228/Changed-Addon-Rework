...
public class LatexWhiteSnowLeopardMaleModel extends AdvancedHumanoidModel<LatexWhiteSnowLeopardMale> implements AdvancedHumanoidModelInterface<LatexWhiteSnowLeopardMale, LatexWhiteSnowLeopardMaleModel> {
    // This layer location should be baked with EntityRendererProvider.Context in the entity renderer and passed into this model's constructor
    public static final ModelLayerLocation LAYER_LOCATION = new ModelLayerLocation(Changed.modResource("latex_white_snow_leopard_male"), "main");
    ...
    private final HumanoidAnimator<LatexWhiteSnowLeopardMale, LatexWhiteSnowLeopardMaleModel> animator;

    public LatexWhiteSnowLeopardMaleModel(ModelPart root) {
        super(root);
    ...
    @Override
    public void prepareMobModel(@NotNull LatexWhiteSnowLeopardMale p_102861_, float p_102862_, float p_102863_, float p_102864_) {
        this.prepareMobModel(animator, p_102861_, p_102862_, p_102863_, p_102864_);
    }

    public void setupHand(LatexWhiteSnowLeopardMale entity) {
        animator.setupHand();
    }

    @Override
    public void setupAnim(@NotNull LatexWhiteSnowLeopardMale entity, float limbSwing, float limbSwingAmount, float ageInTicks, float netHeadYaw, float headPitch) {
    ...
    @Override
    public HumanoidAnimator<LatexWhiteSnowLeopardMale, LatexWhiteSnowLeopardMaleModel> getAnimator(LatexWhiteSnowLeopardMale entity) {
        return animator;
    }
}