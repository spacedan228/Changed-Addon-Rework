package net.foxyas.changedaddon.client.model.simple;// Made with Blockbench 5.0.2
...
public class LatexBorderCollieModel extends AdvancedHumanoidModel<LatexBorderCollieEntity> implements AdvancedHumanoidModelInterface<LatexBorderCollieEntity, LatexBorderCollieModel> {
	public static final ModelLayerLocation LAYER_LOCATION = ChangedAddonMod.layerLocation("border_collie_model", "main");
	...
	private final HumanoidAnimator<LatexBorderCollieEntity, LatexBorderCollieModel> animator;

	public LatexBorderCollieModel(ModelPart root) {
        super(root);
	...
	@Override
	public void setupHand(LatexBorderCollieEntity entity) {
		animator.setupHand();
	}
	...
	@Override
	public HumanoidAnimator<LatexBorderCollieEntity, LatexBorderCollieModel> getAnimator(LatexBorderCollieEntity entity) {
		return animator;
	}
}