...
public class ArmorLatexDazedModel<T extends ChangedEntity> extends LatexHumanoidArmorModel<T, ArmorLatexDazedModel<T>> {
    ...
    public ArmorLatexDazedModel(ModelPart modelPart, ArmorModel model) {
        ...
        this.animator = HumanoidAnimator.of(this).hipOffset(-1.5F).addPreset(AnimatorPresets.wolfLikeArmor(this.Head, this.Torso, this.LeftArm, this.RightArm, this.LeftLeg, leftLowerLeg, leftFoot, leftFoot.getChild("LeftPad"), this.RightLeg, rightLowerLeg, rightFoot, rightFoot.getChild("RightPad")));
    }
