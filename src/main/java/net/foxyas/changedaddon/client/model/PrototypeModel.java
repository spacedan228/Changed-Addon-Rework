...
public class PrototypeModel extends AdvancedHumanoidModel<PrototypeEntity> {
    ...
    private final HumanoidAnimator<PrototypeEntity, PrototypeModel> animator;


    public PrototypeModel(ModelPart root) {
        super(root);
    ...
    public static LayerDefinition createBodyLayer() {
        ...
        PartDefinition Fur_r1 = Head.addOrReplaceChild("Fur_r1", CubeListBuilder.create().texOffs(80, 25).mirror().addBox(0.0F, -2.0F, 0.0F, 2.0F, 2.0F, 3.0F, new CubeDeformation(0.0F)).mirror(false), PartPose.offsetAndRotation(-2.75F, -5.25F, -1.25F, 0.3503F, -0.4557F, -0.6929F));

        PartDefinition Fur_r2 = Head.addOrReplaceChild("Fur_r2", CubeListBuilder.create().texOffs(80, 20).mirror().addBox(0.0F, -2.0F, 0.0F, 2.0F, 2.0F, 3.0F, new CubeDeformation(0.0F)).mirror(false), PartPose.offsetAndRotation(-2.5F, -2.5F, -1.0F, 0.6476F, -0.5857F, -0.9834F));

        PartDefinition Fur_r3 = Head.addOrReplaceChild("Fur_r3", CubeListBuilder.create().texOffs(80, 15).mirror().addBox(0.0F, -2.0F, 0.0F, 2.0F, 2.0F, 3.0F, new CubeDeformation(0.0F)).mirror(false), PartPose.offsetAndRotation(-2.0F, 0.25F, -0.75F, 0.5236F, -0.2291F, -1.1961F));

        PartDefinition Fur_r4 = Head.addOrReplaceChild("Fur_r4", CubeListBuilder.create().texOffs(70, 20).addBox(-2.0F, -2.0F, 0.0F, 2.0F, 2.0F, 3.0F, new CubeDeformation(0.0F)), PartPose.offsetAndRotation(2.5F, -2.5F, -1.0F, 0.6476F, 0.5857F, 0.9834F));

        PartDefinition Fur_r5 = Head.addOrReplaceChild("Fur_r5", CubeListBuilder.create().texOffs(70, 25).addBox(-2.0F, -2.0F, 0.0F, 2.0F, 2.0F, 3.0F, new CubeDeformation(0.0F)), PartPose.offsetAndRotation(2.75F, -5.25F, -1.25F, 0.3503F, 0.4557F, 0.6929F));

        PartDefinition Fur_r6 = Head.addOrReplaceChild("Fur_r6", CubeListBuilder.create().texOffs(70, 15).addBox(-2.0F, -2.0F, 0.0F, 2.0F, 2.0F, 3.0F, new CubeDeformation(0.0F)), PartPose.offsetAndRotation(2.0F, 0.25F, -0.75F, 0.5236F, 0.2291F, 1.1961F));
        ...
        PartDefinition RightEarPivot = RightEar.addOrReplaceChild("RightEarPivot", CubeListBuilder.create().texOffs(0, 4).addBox(-1.9F, -1.2F, -1.0F, 3.0F, 3.0F, 1.0F, new CubeDeformation(0.05F))
                .texOffs(0, 16).addBox(-0.9F, -1.6F, -0.4F, 2.0F, 3.0F, 1.0F, new CubeDeformation(0.049F))
                .texOffs(32, 22).addBox(-0.9F, -2.3F, -1.0F, 2.0F, 1.0F, 1.0F, new CubeDeformation(0.05F))
                .texOffs(24, 0).addBox(0.1F, -3.1F, -1.0F, 1.0F, 1.0F, 1.0F, new CubeDeformation(0.049F)), PartPose.offsetAndRotation(0.5F, -1.25F, 0.0F, -0.1309F, 0.5236F, -0.3491F));
        ...
        PartDefinition LeftEarPivot = LeftEar.addOrReplaceChild("LeftEarPivot", CubeListBuilder.create().texOffs(0, 0).addBox(-1.1F, -1.2F, -1.0F, 3.0F, 3.0F, 1.0F, new CubeDeformation(0.05F))
                .texOffs(0, 20).addBox(-1.1F, -1.6F, -0.4F, 2.0F, 3.0F, 1.0F, new CubeDeformation(0.049F))
                .texOffs(32, 24).addBox(-1.1F, -2.3F, -1.0F, 2.0F, 1.0F, 1.0F, new CubeDeformation(0.05F))
                .texOffs(0, 32).addBox(-1.1F, -3.1F, -1.0F, 1.0F, 1.0F, 1.0F, new CubeDeformation(0.049F)), PartPose.offsetAndRotation(-0.5F, -1.25F, 0.0F, -0.1309F, -0.5236F, 0.3491F));

        PartDefinition Hair = Head.addOrReplaceChild("Hair", CubeListBuilder.create().texOffs(0, 66).addBox(-4.0F, -8.0F, -4.0F, 8.0F, 9.0F, 8.0F, new CubeDeformation(0.2F))
                .texOffs(0, 0).addBox(-4.0F, -8.0F, -4.0F, 8.0F, 8.0F, 8.0F, new CubeDeformation(0.3F)), PartPose.offset(0.0F, 0.0F, 0.0F));
        ...
        PartDefinition Fur_r7 = Torso.addOrReplaceChild("Fur_r7", CubeListBuilder.create().texOffs(82, 10).addBox(-0.5F, -3.0F, 0.0F, 4.0F, 3.0F, 2.0F, new CubeDeformation(0.0F)), PartPose.offsetAndRotation(-0.25F, 0.5F, -0.5F, -0.3352F, -0.2609F, -2.803F));

        PartDefinition Fur_r8 = Torso.addOrReplaceChild("Fur_r8", CubeListBuilder.create().texOffs(82, 5).addBox(-0.5F, -3.0F, 0.0F, 4.0F, 3.0F, 2.0F, new CubeDeformation(0.0F)), PartPose.offsetAndRotation(-0.5F, -0.5F, -1.0F, 0.3091F, 0.3168F, 3.0344F));

        PartDefinition Fur_r9 = Torso.addOrReplaceChild("Fur_r9", CubeListBuilder.create().texOffs(80, 0).mirror().addBox(-3.0F, -3.0F, 0.0F, 3.0F, 3.0F, 2.0F, new CubeDeformation(0.0F)).mirror(false), PartPose.offsetAndRotation(0.0F, 3.75F, 1.25F, 0.1745F, -0.1745F, 0.7854F));

        PartDefinition Fur_r10 = Torso.addOrReplaceChild("Fur_r10", CubeListBuilder.create().texOffs(70, 0).mirror().addBox(-3.0F, -3.0F, 0.0F, 3.0F, 3.0F, 2.0F, new CubeDeformation(0.0F)).mirror(false), PartPose.offsetAndRotation(0.0F, 3.25F, -3.25F, -0.2618F, 0.2618F, 0.7854F));

        PartDefinition Fur_r11 = Torso.addOrReplaceChild("Fur_r11", CubeListBuilder.create().texOffs(70, 10).mirror().addBox(-3.5F, -3.0F, 0.0F, 4.0F, 3.0F, 2.0F, new CubeDeformation(0.0F)).mirror(false), PartPose.offsetAndRotation(0.25F, 0.5F, -0.5F, -0.3352F, 0.2609F, 2.803F));

        PartDefinition Fur_r12 = Torso.addOrReplaceChild("Fur_r12", CubeListBuilder.create().texOffs(70, 5).mirror().addBox(-3.5F, -3.0F, 0.0F, 4.0F, 3.0F, 2.0F, new CubeDeformation(0.0F)).mirror(false), PartPose.offsetAndRotation(0.5F, -0.5F, -1.0F, 0.3091F, -0.3168F, -3.0344F));
    ...
    @Override
    public HumanoidAnimator<PrototypeEntity, PrototypeModel> getAnimator(PrototypeEntity prototypeEntity) {
        return animator;
    }
    ...
    public void setupAnim(@NotNull PrototypeEntity entity, float limbSwing, float limbSwingAmount, float ageInTicks, float netHeadYaw, float headPitch) {
