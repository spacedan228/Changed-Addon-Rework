...
public class MaleExp2Model extends AdvancedHumanoidModel<Exp2MaleEntity> implements AdvancedHumanoidModelInterface<Exp2MaleEntity, MaleExp2Model> {
    ...
    public static final ModelLayerLocation LAYER_LOCATION = new ModelLayerLocation(ResourceLocation.parse("changed_addon", "male_exp2_snep"), "main");
    ...
    private final HumanoidAnimator<Exp2MaleEntity, MaleExp2Model> animator;

    public MaleExp2Model(ModelPart root) {
        super(root);
    ...
    public static LayerDefinition createBodyLayer() {
        ...
        PartDefinition RightFur = RightArm.addOrReplaceChild("RightFur", CubeListBuilder.create().texOffs(0, 65).addBox(-13.0F, -2.0F, -2.0F, 4.0F, 9.0F, 4.0F, new CubeDeformation(0.15F)), PartPose.offset(10.0F, 0.0F, 0.0F));
    ...
    @Override
    public void setupHand(Exp2MaleEntity entity) {
        animator.setupHand();
    }
    ...
    @Override
    public HumanoidAnimator<Exp2MaleEntity, MaleExp2Model> getAnimator(Exp2MaleEntity entity) {
        return animator;
    }
}