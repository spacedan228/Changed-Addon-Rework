...
import net.foxyas.changedaddon.network.packet.UpdateTimedKeypadTimerPacket;
...
public class TimedKeypadTimerScreen extends AbstractContainerScreen<TimedKeypadTimerMenu> {
    ...
    protected void init() {
        ...
        textBox.setY((int) (height * .66f) - textBox.getHeight() / 2);
    ...
    @Override
    protected void renderBg(@NotNull GuiGraphics guiGraphics, float v, int i, int i1) { //is just here to shutup the compiler
        this.renderBackground(guiGraphics);
    }

    @Override
    protected void renderLabels(@NotNull GuiGraphics guiGraphics, int pMouseX, int pMouseY) { //is just here to shutup the compiler
    }
