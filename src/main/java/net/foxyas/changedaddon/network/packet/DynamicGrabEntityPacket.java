...
public class DynamicGrabEntityPacket implements ChangedPacket {
    ...
    public DynamicGrabEntityPacket(LivingEntity source, LivingEntity target, GrabType type) {
        this.sourceEntity = source.getId();
        this.targetEntity = target.getId();
        this.type = type;
    }

    public DynamicGrabEntityPacket(FriendlyByteBuf buffer) {
    ...
    public static DynamicGrabEntityPacket release(Player latexPlayer, LivingEntity entity) {
        return new DynamicGrabEntityPacket(latexPlayer, entity, GrabType.RELEASE);
    }

    public static DynamicGrabEntityPacket initialGrab(Player latexPlayer, LivingEntity entity) {
        return new DynamicGrabEntityPacket(latexPlayer, entity, GrabType.ARMS);
    }

    public static DynamicGrabEntityPacket suitGrab(Player latexPlayer, LivingEntity entity) {
        return new DynamicGrabEntityPacket(latexPlayer, entity, GrabType.SUIT);
    }
