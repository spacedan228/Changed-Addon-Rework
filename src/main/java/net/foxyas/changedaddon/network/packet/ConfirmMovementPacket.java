            ...
            if (sender != null) {
                ...
                if (sender instanceof SyncTrackMotion syncTrackMotion) {
                    ...
                    if (syncTrackMotion.getLastKnownMotion() != null) {
                        //sender.sendMessage(Component.literal("Client motion is: " + syncTrackMotion.getLastKnownMotion()), sender.getUUID());
                    }
                    //sender.sendMessage(Component.literal("Client is moving: " + syncTrackMotion.isMoving()), sender.getUUID());
                }
            }
        });
