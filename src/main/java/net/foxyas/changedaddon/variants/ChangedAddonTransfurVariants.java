...
public class ChangedAddonTransfurVariants {
    ...
    public static final RegistryObject<TransfurVariant<LatexWindCatMaleEntity>> LATEX_WIND_CAT_MALE = register("form_latex_wind_cat/male", TransfurVariant.Builder.of(ChangedAddonEntities.LATEX_WIND_CAT_MALE).doubleJump().stepSize(0.7F).addAbility(ChangedAddonAbilities.DASH).addAbility(ChangedAddonAbilities.WIND_CONTROL).addAbility(ChangedAddonAbilities.WIND_PASSIVE).sound(ChangedSounds.SOUND3.getLocation()));
    public static final RegistryObject<TransfurVariant<LatexWindCatFemaleEntity>> LATEX_WIND_CAT_FEMALE = register("form_latex_wind_cat/female", TransfurVariant.Builder.of(ChangedAddonEntities.LATEX_WIND_CAT_FEMALE).doubleJump().addAbility(ChangedAddonAbilities.DASH).addAbility(ChangedAddonAbilities.WIND_CONTROL).addAbility(ChangedAddonAbilities.WIND_PASSIVE).stepSize(0.7F).sound(ChangedSounds.SOUND3.getLocation()));
