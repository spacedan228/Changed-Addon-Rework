...
public class ChangedAddonTransfurVariants {
    ...
    public static final RegistryObject<TransfurVariant<LatexWindCatMaleEntity>> LATEX_WIND_CAT_MALE = register("form_latex_wind_cat/male", TransfurVariant.Builder.of(ChangedAddonEntities.LATEX_WIND_CAT_MALE).reducedFall().jumpStrength(1.3f).extraJumps(2).stepSize(0.7F).addAbility(ChangedAbilities.TOGGLE_NIGHT_VISION).nightVision().addAbility(ChangedAddonAbilities.LEAP).addAbility(ChangedAddonAbilities.WIND_CONTROL).addAbility(ChangedAddonAbilities.WIND_PASSIVE));
    public static final RegistryObject<TransfurVariant<LatexWindCatFemaleEntity>> LATEX_WIND_CAT_FEMALE = register("form_latex_wind_cat/female", TransfurVariant.Builder.of(ChangedAddonEntities.LATEX_WIND_CAT_FEMALE).reducedFall().jumpStrength(1.3f).extraJumps(2).stepSize(0.7F).addAbility(ChangedAbilities.TOGGLE_NIGHT_VISION).nightVision().addAbility(ChangedAddonAbilities.LEAP).addAbility(ChangedAddonAbilities.WIND_CONTROL).addAbility(ChangedAddonAbilities.WIND_PASSIVE));
