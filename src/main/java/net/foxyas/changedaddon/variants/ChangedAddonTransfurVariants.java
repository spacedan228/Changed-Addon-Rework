...
public class ChangedAddonTransfurVariants {
    ...
    public static final RegistryObject<TransfurVariant<LatexWindCatMaleEntity>> LATEX_WIND_CAT_MALE = register("form_latex_wind_cat/male", TransfurVariant.Builder.of(ChangedAddonEntities.LATEX_WIND_CAT_MALE).reducedFall().extraJumps(2).stepSize(0.7F).addAbility(ChangedAbilities.TOGGLE_NIGHT_VISION).nightVision().addAbility(ChangedAddonAbilities.DASH).addAbility(ChangedAddonAbilities.WIND_CONTROL).addAbility(ChangedAddonAbilities.WIND_PASSIVE).sound(ChangedSounds.SOUND3.getLocation()));
    public static final RegistryObject<TransfurVariant<LatexWindCatFemaleEntity>> LATEX_WIND_CAT_FEMALE = register("form_latex_wind_cat/female", TransfurVariant.Builder.of(ChangedAddonEntities.LATEX_WIND_CAT_FEMALE).reducedFall().extraJumps(2).addAbility(ChangedAbilities.TOGGLE_NIGHT_VISION).nightVision().addAbility(ChangedAddonAbilities.DASH).addAbility(ChangedAddonAbilities.WIND_CONTROL).addAbility(ChangedAddonAbilities.WIND_PASSIVE).stepSize(0.7F).sound(ChangedSounds.SOUND3.getLocation()));
