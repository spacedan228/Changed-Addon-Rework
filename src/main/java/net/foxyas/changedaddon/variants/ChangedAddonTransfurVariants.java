...
public class ChangedAddonTransfurVariants {
    ...
    public static final RegistryObject<TransfurVariant<CrystalGasCatMaleEntity>> HIMALAYAN_CRYSTAL_GAS_CAT_MALE = register("form_himalayan_crystal_gas_cat/male", () -> TransfurVariant.Builder.of(ChangedAddonEntities.CRYSTAL_GAS_CAT_MALE).addAbility(ChangedAddonAbilities.CLAWS).jumpStrength(1.1f).nightVision().addAbility(ChangedAbilities.TOGGLE_NIGHT_VISION).scares(List.of(Creeper.class, Rabbit.class)));
