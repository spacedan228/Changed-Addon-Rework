...
public class ENLanguageProvider extends LanguageProvider {
    ...
    protected void addTranslations() {
        ...
        add(toLanguageKey(TIMED_KEYPAD.getId(), "block") + ".info", "Timer set: (%s) ticks");//FIXME move to a better key
        ...
        addAbility("custom_interaction.have_interaction.avali.extra", "Scale selected %s");
        addAbility("custom_interaction.have_interaction.latex_snep", "Allow the Player to be on the LOAF pose when crouching");
        addAbility("custom_interaction.have_interaction.luminarctic_leopards", "Allow the Player to turn on the glowing parts of they body");
        ...
        addAbility("dodge", "Dodge Ability");
        addAbility("dodge.dodge_amount", "Stamina: %1$s");
        addAbility("dodge.dodge_amount_left", "Stamina: %1$s");
        addAbility("dodge.ultra_instinct", "§b§oUltra Instinct§r");
        addAbility("dodge.ultra_instinct.activated", "§b§oYour instincts sharpen to perfection — you feel as swift as a god.§r");
        addAbility("dash", "Dash");
        ...
        addAbility("turn_feral.can", "You §acan§r Turn Feral");
        addAbility("wing_flap", "Wing Flap");
        ...
        addAbility("wind_control_passive", "Wind Control Passive");
        addAbility("wind_control_passive.desc", "Allows the player to use Wind to walk on fluids. But be careful, you'll still touch the fluid.");
        addAbility("passive.toggle.on", "Your passive is now Enabled");
        addAbility("passive.toggle.off", "Your passive is now Disabled");
        addAbility("sonar", "Sonar");
        addAbility("sonar.desc", "Unleash a resonant pulse that reveals living beings through walls and obstacles.");
        addAbility("fireball", "Luminara Fireball");
        addAbility("fireball.desc", "Unleash a blazing fireball fueled by your current power state — the greater your strength, the more devastating the flames.");
        ...
        addCommand("ultra_instinct.fail", "%s cannot use Ultra Instinct.");
        addCommand("ultra_instinct.disabled", "Ultra Instinct disabled for %s.");
        addCommand("ultra_instinct.enabled", "Ultra Instinct enabled for %s.");
        addCommand("ultra_instinct.more", "...and %s more.");

        addEntityDialogues("exp1.death.text1", "§7§lI... I tried my best to protect you... I'm really sorry...§r");
        addEntityDialogues("exp1.death.text2", "§7§lOh no! We fell down... But don't worry, you tried your best!§r");
        addEntityDialogues("exp1.death.text3", "§7§lOh... I'm so sorry. I thought I could keep us safe...§r");
        addEntityDialogues("exp1.death.text4", "§7§lS-So much for being a force of nature huh %s? ...Sorry...I thought I was strong enough..§r.");
        addEntityDialogues("exp1.transfur.text.secret", "Yay~! You're one of the smart ones! I like you already!");
        addEntityDialogues("exp2.death.text1", "§8§lI...I... I Won't Let You §oDown§r §8§lAgain!");
        addEntityDialogues("exp2.death.text2", "§8§lSorry, I Couldn't Keep Us Standing up...§r");
        ...
        addEntityDialogues("exp9.reaction.fire_damage", "You’re fighting a storm with a match.... You didn’t miscalculate — you misunderstood.");
        ...
        addEntityDialogues("exp10.pat.type_3", "§l§4You dare toy with me? This was your last mistake.");
        addEntityDialogues("exp10.reaction.range_attacks", "§l§o§4What's that peashooter going to do, hurt me? I don't think so, weakling.");
        addEntityDialogues("exp10.reaction.fire_damage", "§4Did you truly believe fire could harm me? In §lthis form§r§4, I am beyond such flaws.§r");
        addEntityDialogues("exp10.death.text1", "§4§l§oSo much potential, wasted in a single breath... pathetic.§r");
        addEntityDialogues("exp10.death.text2", "§4§l§oAnd even with all this power, you found a way to die...§r");
        ...
        addJeiDescriptions("diffusion_syringe", "Untransfurs you back to human form while summoning your previous transfur form.");
        addJeiDescriptions("exp9_dna", "Found within a specific room in a §lfacility§r with chemical compounds in boxes.");
        addJeiDescriptions("informant_block", "Show the stats of the transfur of any Transfur Holder Item (or just any item with the \"form\" nbt), it also allow you see the stats when in inventory");
        addJeiDescriptions("iridium_use", "It can be applied to specific blocks to make them reinforced.");
        addJeiDescriptions("laethin_syringe", "When using Untransfur you Instantly and don't have a chance to fail");
        addJeiDescriptions("latex_totem", "Can save a Transfur Variant and can give you fully control about the transformations");
        addJeiDescriptions("litix_cammonia_syringe", "When untransfurring there is a 44% chance of failure.");
        addJeiDescriptions("lunar_rose", "§f§lWhisper of the Lunar Bloom§r#§oIn twilight’s hush, a flower concealed,#§oA silent glow, its fate is sealed.#§oBorn from a mirror that hides the light,#§oAnd a frozen tear, both pure and bright.#§oThrough hands unseen, they intertwine, §oIn crafted bond, their fates align.#§oNo flame nor forge shall shape its form,#§oYet under stars, it shall be born. #§oSeek the unseen, let wisdom ignite,#§oFor only the knowing shall glimpse its light.");
        ...
        addSound(EXP10_THEME, "Experiment 10 Music Theme");
        addSound(EXP9_THEME, "Experiment 009 Music Theme(Meaningless Strafe)");
        addSound(HAMMER_GUN_SHOT, "Hammer Gun Shot");
        addSound(HAMMER_SWING, "Hammer Swing");
        addSound(LUMINARCTIC_LEOPARD, "Misstake playing");
        addSound(SPRAY_SOUND, "Using Spray");
        addSound(ChangedAddonSoundEvents.UNTRANSFUR, "Untransfurmization");
        addSound(WARN, "Warn Sound");
        addSound(GECKO_BEEP, "Gecko Beep");
        addSound(PROTOTYPE_IDEA, "Prototype Chime");
        ...
        addCommand("accessory.invalid_slot.single", "%s does not have the accessory slot %s.");
        addCommand("accessory.invalid_slot.multiple", "%s does not have the accessory slot %s, ignoring and passing to the next.");
        addCommand("accessory.set.success", "%s now has %s in slot %s.");
        addCommand("accessory.set.invalid_item", "%s cannot equip %s in slot %s.");
        addCommand("accessory.set.locked", "%s cannot equip %s in slot %s because another accessory blocks it.");
        addCommand("accessory.set.slot_locked", "%s cannot equip %s in slot %s because the slot type is not available");
        addCommand("accessory.get.success", "%s has %s in slot %s.");
        addCommand("accessory.too_many", "Too much data requested, only showing the first %s results.");
