...
public class HULanguageProvider extends LanguageProvider {
    ...
    public HULanguageProvider(PackOutput output) {
        super(output, ChangedAddonMod.MODID, "hu_hu");
    }
    ...
    protected void addTranslations() {
        ...
        add(toLanguageKey(TIMED_KEYPAD.getId(), "block") + ".info", "Időzítő beállítva: (%s) tikk");//FIXME move to a better key
        ...
        addAbility("custom_interaction.have_interaction.avali.extra", "Kiválasztott méret: %s");
        addAbility("custom_interaction.have_interaction.latex_snep", "Lehetővé teszi a játékosnak, hogy kenyér pózban legyen, amikor lopakodik.");
        addAbility("custom_interaction.have_interaction.luminarctic_leopards", "Lehetővé teszi a játékosnak, hogy bekapcsolja testének világító részeit.");
        ...
        addAbility("dodge", "Kitérés");
        addAbility("dodge.dodge_amount", "Kitartás: %1$s");
        ...
        addAbility("pollen_carry.display.can", "Gyűjtöttem egy kis virágport!");
        addAbility("pollen_carry.display.cant", "Nem hiszem, hogy ebből virágport szerezhetek.");
        addAbility("psychic_grab", "Telepatikus megragadás");
        addAbility("psychic_grab.description", "Lehetővé teszi a felhasználó számára, hogy telepatikusan megragadjon egy közeli entitást – élőlényt vagy tárgyat – és irányítsa annak mozgását. A nyílgombokkal állíthatod be a tartott pozíciót (a Shift billentyű lenyomva tartásával előre vagy hátra mozgathatod), így közelebb húzhatod, felemelheted vagy oldalra tolhatod a célt. ⚠ Ez a képesség alacsony teljesítményű rendszereken vagy laggos környezetben inkonzisztensen működhet vagy akadozhat.");
        addAbility("psychic_hold", "Telepatikus tartás");
        addAbility("psychic_pulse", "Telepatikus pulzus");
        addAbility("shock_wave", "Lökéshullám");
        addAbility("soften", "Lágyulás");
        addAbility("soften.description", "Hagyja, hogy a játékos áthaladjon lyukas blokkokon");
        addAbility("thunder", "Villám");
        addAbility("thunder_path", "Villámút");
        addAbility("turn_feral", "Ferallá válás");
        addAbility("turn_feral.can", "Feral lénnyé §atud§r változni");
        addAbility("wing_flap", "Szárnycsapkodás");
        addAbility("wither_wave", "Sorvadás hulláma");
        addAbility("teleport", "Teleportálás");
        addAbility("unfuse", "Elkülönítés");
        addAbility("unfuse.description.line1", "Lehetővé teszi a játékosnak, hogy elkülönüljön a latex lénytől, és harcba hívja azt");
        addAbility("unfuse.description.line2", "A lényt a Shift billentyű lenyomva tartásával történő interakcióval lehet visszaolvasztani");
        addAbility("wind_control", "Szélszabályozás");
        addAbility("wind_control.desc", "Lehetővé teszi a játékos számára, hogy a szelet használja saját maga vagy mások fellendítésére");
        addAbility("wind_control.desc2", "[Tartsa lenyomva a Shift billentyűt az AOE változat használatához]");
        addAbility("wind_control_passive", "Passzív szélszabályozás");
        addAbility("wind_control_passive.desc", "Lehetővé teszi a játékos számára, hogy a szél segítségével folyadékokon járjon. De légy óvatos, mert így is hozzáérsz a folyadékhoz.");
        addAbility("passive.toggle.on", "A passzív képességed mostantól engedélyezve van");
        addAbility("passive.toggle.off", "A passzív képességed mostantól le van tiltva");
        addAbility("sonar", "Hanglokátor");
        addAbility("sonar.desc", "Engedj szabadjára egy rezonáns impulzust, amely élőlényeket tár fel falakon és akadályokon keresztül.");
        addAbility("fireball", "Luminara tűzgolyó");
        addAbility("fireball.desc", "Engedj szabadjára egy lángoló tűzgolyót, amelyet az aktuális energiaszinted táplál – minél nagyobb az erőd, annál pusztítóbbak a lángok.");
        ...
        addCommand("ultra_instinct.fail", "%s nem használhat túlzott ösztönt.");
        addCommand("ultra_instinct.disabled", "Túlzott ösztön letiltva %s számára.");
        addCommand("ultra_instinct.enabled", "Túlzott ösztön engedélyezve %s számára.");
        addCommand("ultra_instinct.more", "...és még %s.");

        addEntityDialogues("exp1.death.text1", "§7§lÉn... én mindent megtettem, hogy megvédjelek... Nagyon sajnálom...§r");
        addEntityDialogues("exp1.death.text2", "§7§lÓ, ne! Elestünk... De ne aggódj, mindent megtettél!§r");
        addEntityDialogues("exp1.death.text3", "§7§lÓ... Annyira sajnálom. Azt hittem, meg tudlak minket védeni...§r");
        addEntityDialogues("exp1.death.text4", "§7§lS-Ennyit arról, hogy természeti erő vagy, ugye %s? ...Bocsánat...Azt hittem, elég erős vagyok..§r.");
        addEntityDialogues("exp1.transfur.text.secret", "Hurrá! Te egyike vagy az okosoknak! Máris kedvellek!");
        addEntityDialogues("exp2.death.text1", "§8§lNem...Nem... Nem foglak §8§lújra§r §ocserben§r hagyni!");
        addEntityDialogues("exp2.death.text2", "§8§lBocsánat, nem tudtam talpon tartani minket...§r");
        ...
        addEntityDialogues("exp10.pat.type_3", "§l§4Mersz velem játszani? Ez volt az utolsó hibád.");
        addEntityDialogues("exp10.reaction.range_attacks", "§l§o§4Mit fog azzal a fúvócsővel csinálni, bántani? Nem hiszem, te gyenge teremtmény.");
        addEntityDialogues("exp10.reaction.fire_damage", "§4Komolyan azt hitted, hogy a tűz árthat nekem? Ebben §la formában§r§4 túl vagyok az ilyen hibákon.§r");
        addEntityDialogues("exp10.death.text1", "§4§l§oAnnyi potenciál, egyetlen lélegzetvétel alatt elpazarolva... szánalmas.§r");
        addEntityDialogues("exp10.death.text2", "§4§l§oÉs még ennyi hatalom mellett is találtál módot arra, hogy meghalj...§r");
        ...
        addJeiDescriptions("diffusion_syringe", "Visszatranszfurál emberi formába, miközben megidézi korábbi transzfurált formáját.");
        addJeiDescriptions("exp9_dna", "Egy §llétesítmény§r egy meghatározott helyiségében található, dobozokban tárolt vegyi anyagok.");
        addJeiDescriptions("informant_block", "Mutassa meg bármely transzfurtartó tárgy (vagy csak bármely, \"form\" nbt-vel rendelkező tárgy) transzfuráltjának statisztikáit, és lehetővé teszi a statisztikák megtekintését a felszerelésben is");
        addJeiDescriptions("iridium_use", "Alkalmazható bizonyos blokkokra, hogy azok megerősödjenek.");
        addJeiDescriptions("laethin_syringe", "Visszatranszfur használata azonnali, és nincs esély a kudarcra");
        addJeiDescriptions("latex_totem", "A transzfurált változatokat elmentheti, és teljes ellenőrzést kaphat a transzformációk felett");
        addJeiDescriptions("litix_cammonia_syringe", "A visszatranszfur során 44% az esély a kudarcra.");
        addJeiDescriptions("lunar_rose", "§f§lA holdvirág suttogása§r#§oA szürkület csendjében egy virág rejtőzik,#§oCsendes ragyogás, sorsa megpecsételődött.#§oA fényt elrejtő tükörből született,#§oÉs egy fagyos könnyből, tiszta és ragyogó.#§oLáthatatlan kezek által összefonódnak, §oKézműves kötelékben, sorsuk egybefonódik.#§oSem láng, sem kovácsműhely nem formálja alakját,#§oDe a csillagok alatt megszületik. #§oKeresd a láthatatlant, hagyd, hogy a bölcsesség lángra gyúljon,#§oMert csak a tudók pillanthatnak meg fényét.");
        ...
        addGui("transfur_sounds_gui.fox_scream", "Róka sikoly");
        ...
        addSound(EXP10_THEME, "10-es kísérlet témazenéje");
        addSound(EXP9_THEME, "009-es kísérlet témazenéje (Meaningless Strafe)");
        addSound(HAMMER_GUN_SHOT, "Kalapácsfegyver lövése");
        addSound(HAMMER_SWING, "Kalapács lengetése");
        addSound(LUMINARCTIC_LEOPARD, "Misstake lejátszva");
        addSound(SPRAY_SOUND, "Szpré használata");
        addSound(ChangedAddonSoundEvents.UNTRANSFUR, "Visszatranszfur");
        ...
        addCommand("accessory.invalid_slot.multiple", "%s nem rendelkezik a(z) %s kellék rekesszel, figyelmen kívül hagyja és a következőre ugrik.");
        addCommand("accessory.set.success", "%s mostantól %s-t tartalmaz a(z) %s rekeszben.");
        addCommand("accessory.set.invalid_item", "%s nem tudja felszerelni a(z) %s kelléket a(z) %s rekeszben.");
        addCommand("accessory.set.locked", "%s nem tudja felszerelni a(z) %s kelléket a(z) %s rekeszben, mert egy másik kellék blokkolja.");
        addCommand("accessory.set.slot_locked", "%s nem tudja felszerelni a(z) %s kelléket a(z) %s rekeszben, mert a rekesz típusa nem elérhető.");
        addCommand("accessory.get.success", "%s tartalmaz %s-t a(z) %s rekeszben.");
        addCommand("accessory.too_many", "Túl sok adatot kért a rendszer, csak az első %s találatot mutatja.");
        addCommand("alpha.set.success", "Alfa gén %sra állítva %s entitásokhoz");
